...
/*
 * Init and run calls for ADRC_loiter flight mode
 */
...
// ADRC_loiter_init - initialise ADRCloiter controller
bool Copter::ModeADRCloiter::init(bool ignore_checks)
{
...
bool Copter::ModeADRCloiter::do_precision_loiter()
{
...
void Copter::ModeADRCloiter::precision_loiter_xy()
{
    loiter_nav->clear_pilot_desired_acceleration();
...
void Copter::ModeADRCloiter::run()
{
    ...
    ADRCROLL.ADRC_flag = 1; 
    ADRCPITCH.ADRC_flag = 1;  
    ADRCYAW.ADRC_flag = 1; 
    ADRC_POS_X.ADRC_flag = 1;
    ADRC_POS_Y.ADRC_flag = 1;
    ADRC_POS_Z.ADRC_flag = 1;
...
uint32_t Copter::ModeADRCloiter::wp_distance() const
{
    return loiter_nav->get_distance_to_target();
}

int32_t Copter::ModeADRCloiter::wp_bearing() const
{
